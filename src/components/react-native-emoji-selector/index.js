...
<TouchableOpacity onPress={() => onCancel()} style={{ height: hp('4%'), width: hp('4%'),  alignSelf: 'center', marginLeft:5, marginRight: 10 }}>
                      <Image resizeMode='contain' style={{alignSelf: 'center' }} source={Images.cancelIcon1} />
                    </TouchableOpacity>
