...
const CustomPickerView = (props) => {
    return (
        <View style={{ bottom: 0, alignSelf: 'center', justifyContent: 'center', position: 'absolute', backgroundColor: 'transparent', height: Platform.OS === 'ios' ? hp('11%') : hp('12.5%'), alignItems: 'center', width: '100%', marginBottom: isiPhoneX() ? hp('9.5%') : Platform.OS === 'ios' ? hp('6%') : hp('7.2%') }}>
