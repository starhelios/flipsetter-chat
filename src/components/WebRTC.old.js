...
let started = false;
let myroom = 1208069292539617;
let roompin = "1MNBxm";
let secret = "JBuuOuXZknwf";
...
class WebRTC extends Component<Props> {
    ...
    componentDidUpdate(prevProps: Readonly<P>, prevState: Readonly<S>, snapshot: SS): void {
        // // console.log("props", this.props.app.appState, prevProps.app.appState);
                    ...
                    if(event === "joined"){
                        ...
                        if(msg["publishers"] !== undefined && msg["publishers"] !== null){
                            ...
                            for(var f in list) {
                                ...
                                if(talking){this.newRemoteFeed(id, display);}
